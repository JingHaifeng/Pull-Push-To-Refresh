...
public class PtrClassicDefaultFooter extends FrameLayout implements PtrUIHandler {
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.cube_ptr_pull_up_to_refresh));
        } else {
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        SharedPreferences
                sharedPreferences = getContext().getSharedPreferences(KEY_SharedPreferences, 0);
