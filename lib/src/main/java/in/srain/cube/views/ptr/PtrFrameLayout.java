...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            ...
            ratio = mPtrIndicator.getRatioOfFooterHeightToRefresh();
            ratio = arr.getFloat(R.styleable.PtrFrameLayout_ptr_ratio_of_footer_height_to_refresh, ratio);
            mPtrIndicator.setRatioOfFooterHeightToRefresh(ratio);

            ratio = mPtrIndicator.getMaxRatioToPull();
            ratio = arr.getFloat(R.styleable.PtrFrameLayout_ptr_max_ratio_to_pull, ratio);
            mPtrIndicator.setMaxRatioToPull(ratio);
    ...
    private void updatePos(int change) {
        ...
        if (mPtrUIHandlerHolder.hasHeaderHandler() || mPtrUIHandlerHolder.hasFooterHandler()) {
